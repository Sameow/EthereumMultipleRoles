...
contract ERC20 {
  ...
  */
   ...
   */
  function transferTokenFrom(address _from, address _to, uint256 _value) public returns (bool) {
    require(_to != address(0));
   ...
   */
  function mintToken(address _to, uint256 _amount) onlyOwner canMint public returns (bool) {
